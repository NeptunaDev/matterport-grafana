...
export declare namespace Mattertag {
	...
	interface IMessenger {
		 ...
		 */
		send(eventType: string, ...args: unknown[]): void;
		/**
		 * Add a handler for messages of type `eventType` from the iframe sandbox
		 */
		on(eventType: string, eventHandler: (...args: unknown[]) => void): void;
		/**
		 * Remove a handler for messages of type `eventType` from the iframe sandbox
		 */
		off(eventType: string, eventHandler: (...args: unknown[]) => void): void;
	}
...
declare function off(event: unknown, callback: (...any: unknown[]) => void): Emitter;
